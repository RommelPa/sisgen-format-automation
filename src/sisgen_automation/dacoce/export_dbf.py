...
def export_dacoce_dbf(
    ...
    assert_sisgen_expected_layout(source_dbf_path, "DACOCE")
    validation_result = validate_dacoce_template(
    ...
    if validation_result.has_errors:
        raise ValueError(
            "La plantilla DACOCE tiene errores. Corrige la plantilla antes de exportar el DBF."
        )
    ...
    if output_path is None:
        output_path = Path("data") / "output" / period / "DACOCE.DBF"
