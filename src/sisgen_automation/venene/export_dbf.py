...
from sisgen_automation.venene.template import parse_period
from sisgen_automation.venene.template_validation import (
    EnergyTemplateRecord,
    validate_venene_template,
)
...
def default_venene_output_path(period: str) -> Path:
    return Path("reports") / "dbf" / period / "VENENE.DBF"
...
def export_venene_dbf(
    *,
    ...
    validation_result = validate_venene_template(
    ...
    if validation_result.has_errors:
        raise ValueError("La plantilla VENENE tiene errores. Corrige la plantilla antes de exportar el DBF.")
    ...
    if output_path is None:
        output_path = default_venene_output_path(period)
